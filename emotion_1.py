...
def upload():
    ...
    while True:
     ...
     ###########################################################################################################        #cv2.waitKey(1);
        ...
        cv2.imshow('Video', cv2.resize(img,(500,500),interpolation = cv2.INTER_CUBIC))
...
def files_count():
    ...
    happy = 'E:/2024-2025 New Code/Music 100% code/music recommendation system/dataset/happy'
   ...
   # print(B)
    ...
    sad = 'E:/2024-2025 New Code/Music 100% code/music recommendation system/dataset/sad'
    ...
    neutral = 'E:/2024-2025 New Code/Music 100% code/music recommendation system/dataset/neutral'
    ...
    # Surprised = 'D:/2022 PROJECT/22CB project/22CB149-/music recommendation system/dataset/Surprised'
    ...
    # Disgusted = 'D:/2022 PROJECT/22CB project/22CB149-/music recommendation system/dataset/Disgusted'
